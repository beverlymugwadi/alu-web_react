...
describe('Normalized data', () => {
  ...
  it('should have correct users entity for user 5debd764a7c57c7839d722e9', () => {
    const userId = '5debd764a7c57c7839d722e9';
    const expectedUser = {
      age: 25,
  ...
  it('should have correct messages entity for guid efb6c485-00f7-4fdf-97cc-5e12d14d6c41', () => {
  ...
  it('should have correct notifications entity for notification 5debd7642e815cd350407777', () => {
